	...
	a.widget("ui.chatbox", {
		...
		"_create": function() {
			var b = this,
				c = b.options,
				d = c.title || "No Title",
				e = (b.uiChatbox = a("<div></div>")).appendTo($("#shortcutMenu_overlay")).addClass("card border mb-4 mb-xl-0").attr("outline", 0).focusin(function() {
					b.uiChatboxTitlebar.addClass("ui-state-focus")
				}).focusout(function() {
					b.uiChatboxTitlebar.removeClass("ui-state-focus")
				}),
				f = (b.uiChatboxTitlebar = a("<div></div>")).addClass("card-header bg-trans-gradient py-2 pr-2 d-flex align-items-center flex-wrap ").click(function(a) {
					b.toggleContent(a)
				}).appendTo(e),
				...
				i = (a("<i></i>").addClass("fa fa-minus").appendTo(h), (b.uiChatboxContent = a('<div class="' + b.options.alertshow + '"><span class="alert-msg">' + b.options.alertmsg + "</span></div>")).addClass("card-body ").appendTo(e)),
				j = ((b.uiChatboxLog = b.element).addClass("card-text ").appendTo(i), (b.uiChatboxInput = a("<div></div>")).addClass("form-content-editable ").click(function(a) {}).appendTo(i)),
				k = (b.uiChatboxInputBox = a("<textarea></textarea>")).addClass("form-content-editable ").appendTo(j).keydown(function(c) {
